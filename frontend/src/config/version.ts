...
export const CURRENT_VERSION: VersionInfo = {
  ...
  features: [
    ...
    'Container All-in-One per deploy semplificato',
    'Sistema intelligente di gestione porte con auto-detection',
    'Deploy flessibile: All-in-One, Docker Hub, Build locale',
  ...
  changelog: [
    'v1.1.1 - Container All-in-One e gestione porte intelligente',
    'Aggiunto container monolitico con tutti i servizi integrati',
    'Implementato sistema intelligente di rilevamento conflitti porte',
    'Script automatico di configurazione con auto-detection',
    'Modalità deploy flessibili: semplificato vs scalabile',
    'Documentazione completa per tutti i metodi di deployment',
